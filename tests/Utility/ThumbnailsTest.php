...
{
    // test images
    private const string IMAGE_SQUARE = 'square.png'; // (200x200)
    private const string IMAGE_LANDSCAPE = 'landscape.png'; // (200x100)
    private const string IMAGE_PORTRAIT = 'portrait.png'; // (100x200)
    private const array IMAGE_SOURCES = [
    ...
    // Folders
    private const string BASE_FOLDER = __DIR__ . '/../../var/cache/test/thumbnails';
    private const string SOURCE_FOLDER = 'source';
    private const array IMAGE_FOLDERS = [
        '50x50',
        '50x200',
        '50x300',
        '100x100',
