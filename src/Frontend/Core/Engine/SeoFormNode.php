...
class SeoFormNode extends Node
{
    ...
    public function compile(Compiler $compiler): void
    {
        $compiler
            ...
            ->write('echo "<h2 class=\"panel-title\">' . $this->lbl('Titles') . '</h2>";')
            ->write('echo \'</div>\';')
        ...
        $compiler
            ...
            ->write('echo \'<ul class="list-unstyled checkboxTextFieldCombo">\';')
            ->write('echo \'<li class="checkbox">\';')
            ->write('echo "<p><label for=\"navigationTitleOverwrite\">";')
            ...
            ->write('echo "<label for=\"navigationTitle\" class=\"sr-only\">";')
        ...
        $compiler
            ...
            ->write('echo \'<div class="panel panel-default">\';')
            ->write('echo \'<div class="panel-heading">\';')
            ->write('echo "<h2 class=\"panel-title\">' . $this->lbl('MetaInformation') . '</h2>";')
            ->write('echo \'</div>\';')
            ->write('echo \'<div class="panel-body">\';')
            ->write('echo \'<div class="form-group">\';')
            ->write('echo \'<ul class="list-unstyled checkboxTextFieldCombo">\';')
            ->write('echo \'<li class="checkbox">\';')
            ->write('echo "<p><label for=\"metaDescriptionOverwrite\">";')
            ...
            ->write('echo "<label for=\"metaDescription\" class=\"sr-only\">";')
        ...
        $compiler
            ...
            ->write('echo "<label for=\"url\" class=\"sr-only\">";')
            ...
            ->write('echo \'<div class="panel panel-default">\';')
            ->write('echo \'<div class="panel-heading">\';')
            ->write('echo "<h2 class=\"panel-title\">' . $this->lbl('SEO') . '</h2>";')
            ->write('echo \'</div>\';')
            ->write('echo \'<div class="panel-body">\';')
