...
{
    public function testArchiveContainsBlogPosts(KernelBrowser $client): void
    {
        $this->loadFixtures(
            $client,
            [
    ...
    public function testArchiveWithOnlyYearsContainsBlogPosts(KernelBrowser $client): void
    {
        $this->loadFixtures(
            $client,
            [
    ...
    public function testArchiveWithWrongMonthsGives404(KernelBrowser $client): void
    {
