    ...
    private function validateForm(): void
    {
        ...
        if ($this->form->isSubmitted()) {
            ...
            if ($this->form->isCorrect()) {
                ...
                $this->redirect(BackendModel::createUrlForAction('ThemeTemplates') . '&theme=' . $item['theme'] . '&report=added-template&var=' . rawurlencode((string) $item['label']) . '&highlight=row-' . $item['id']);
            }
        }
    }
}
